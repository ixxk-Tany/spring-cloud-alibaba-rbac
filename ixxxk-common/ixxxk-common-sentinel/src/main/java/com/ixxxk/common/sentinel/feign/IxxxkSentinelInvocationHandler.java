package com.ixxxk.common.sentinel.feign;
 ...
 */
@Slf4j
public class IxxxkSentinelInvocationHandler implements InvocationHandler {
	...
	IxxxkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			IxxxkSentinelInvocationHandler other = (IxxxkSentinelInvocationHandler) obj;
